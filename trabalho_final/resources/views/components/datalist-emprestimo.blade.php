            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('FUNCIONÁRIO: {{ $item->funcionario->nome }}', 'FERRAMENTA: {{$item->ferramenta->nome}}', 'QUANTIDADE: {{ $item->quantidade }}')" class="btn btn-primary">
