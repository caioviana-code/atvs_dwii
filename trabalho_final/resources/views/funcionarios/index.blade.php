...
<div>
    ...
    <table class="table align-middle caption-top table-striped">
        ...
        <caption>Tabela de <b>Funcionários</b></caption>
            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <a href= "{{ route('funcionarios.edit', $item->id) }}" class="btn btn-success">
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('NOME: {{ $item->nome }}', 'EMAIL: {{ $item->email }}', 'CPF: {{ $item->cpf }}')" class="btn btn-primary">
                    ...
                    <form action="{{ route('funcionarios.destroy', $item['id']) }}" method="POST" id="form_{{$item['id']}}">
                        @csrf
                        @method('DELETE')
                    </form>
                </tr>
